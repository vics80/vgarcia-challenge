...
final class Version20260603174750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id BINARY(16) NOT NULL, name VARCHAR(120) NOT NULL, selector VARCHAR(20) NOT NULL, price_cents INT NOT NULL, stock_quantity INT NOT NULL, max_stock_quantity INT NOT NULL, UNIQUE INDEX uniq_products_selector (selector), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
